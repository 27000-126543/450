...
export const mockAlertEvents: AlertEvent[] = [
  {
    ...
    approvalFlow: [{ step: 1, role: 'city', approver: '深圳运维中心', status: 'pending' }, { step: 2, role: 'province', approver: '广东省公司', status: 'pending' }, { step: 3, role: 'group', approver: '集团总部', status: 'pending' }],
  },
  {
    ...
    approvalFlow: [{ step: 1, role: 'city', approver: '重庆运维中心', status: 'approved', timestamp: '2026-06-13 15:00:00' }, { step: 2, role: 'province', approver: '四川省公司', status: 'pending' }, { step: 3, role: 'group', approver: '集团总部', status: 'pending' }],
  },
  {
    ...
    status: 'pending', createdAt: '2026-06-14 10:15:00', deadline: '2026-06-15 10:15:00',
    approvalFlow: [{ step: 1, role: 'city', approver: '北京运维中心', status: 'pending' }, { step: 2, role: 'group', approver: '集团总部', status: 'pending' }],
  },
  {
    ...
    approvalFlow: [{ step: 1, role: 'city', approver: '南京运维中心', status: 'pending' }, { step: 2, role: 'province', approver: '江苏省公司', status: 'pending' }, { step: 3, role: 'group', approver: '集团总部', status: 'pending' }],
  },
  {
    ...
    approvalFlow: [{ step: 1, role: 'city', approver: '成都运维中心', status: 'approved', timestamp: '2026-06-11 17:00:00' }, { step: 2, role: 'province', approver: '四川省公司', status: 'approved', timestamp: '2026-06-12 09:00:00' }, { step: 3, role: 'group', approver: '集团总部', status: 'pending' }],
  },
  {
    ...
    approvalFlow: [{ step: 1, role: 'city', approver: '上海运维中心', status: 'pending' }, { step: 2, role: 'province', approver: '上海市公司', status: 'pending' }, { step: 3, role: 'group', approver: '集团总部', status: 'pending' }],
  },
  {
    ...
    approvalFlow: [{ step: 1, role: 'city', approver: '济南运维中心', status: 'approved', timestamp: '2026-06-13 12:00:00' }, { step: 2, role: 'province', approver: '山东省公司', status: 'pending' }, { step: 3, role: 'group', approver: '集团总部', status: 'pending' }],
  },
  {
    id: 'alert-008', level: 1, cableSegmentId: 'cs-009', cableSegmentName: '武汉城域光缆-东湖段', province: '湖北', city: '武汉',
    triggerReason: '路由偏移检测', triggerData: [{ timestamp: '2026-06-14 12:50:00', value: 2.3 }],
    status: 'pending', createdAt: '2026-06-14 13:00:00', deadline: '2026-06-15 01:00:00',
    approvalFlow: [{ step: 1, role: 'city', approver: '武汉运维中心', status: 'pending' }, { step: 2, role: 'group', approver: '集团总部', status: 'pending' }],
  },
]
...
export const mockWeeklyReports: WeeklyReport[] = [
  {
    id: 'wr-001', weekStart: '2026-06-08', weekEnd: '2026-06-14',
    ...
    recommendations: ['深圳段紧急修复方案已启动', '加强重庆段巡检频次'],
  },
  {
    id: 'wr-002', weekStart: '2026-06-08', weekEnd: '2026-06-14',
    ...
    recommendations: ['重庆段健康指数持续偏低需重点关注', '成都段护套破损待集团审批'],
  },
  {
    id: 'wr-003', weekStart: '2026-06-08', weekEnd: '2026-06-14',
    ...
    recommendations: ['昌平回龙观段已升级为集团级告警', '建议启动更换方案'],
  },
  {
    ...
    recommendations: ['南京段衰减问题已定位', '计划本周完成接头更换'],
  },
]
